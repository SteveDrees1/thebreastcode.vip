...
Guides generated by the companion
[`workshop-guide`](https://github.com/SteveDrees1/workshop-guide) repository drop
straight into this flow: build the PDF, upload it, add the row.
